...
test("POS shell wires a Counter scale dock and USB / Bluetooth helpers", () => {
  ...
  assert.equal(typeof S.connectNetwork, "function");
  assert.equal(S.loadSettings("t").enabled, true);
});
