...
test("HTML and CSS cache stickers match deploy136", () => {
  ...
  const masterHtml = readFileSync(path.join(root, "master.html"), "utf8");
  assert.match(masterHtml, /20260914mlux1/);
  assert.doesNotMatch(masterHtml, /20260905deploy172/);
  ...
  assert.match(masterHtml, /id="master-gate"/);
  assert.match(masterHtml, /id="master-app"/);
  assert.match(masterHtml, /auth-shell-v2/);
  assert.doesNotMatch(masterHtml, /india-theme/);
  ...
  const saas = readFileSync(path.join(root, "css/saas.css"), "utf8");
  assert.match(saas, /master-login-ux: shop-matching gate 2026/);
  assert.match(readFileSync(path.join(root, "js/master.js"), "utf8"), /function showLogin/);
  assert.match(readFileSync(path.join(root, "js/master.js"), "utf8"), /master-pass-toggle/);
  ...
  assert.match(appJs, /function pharmacyStockCards/);
  assert.match(appJs, /\/api\/batches\?on_hand=1/);
  ...
  assert.doesNotMatch(saas, /india-theme/);
