...
test("HTML and CSS cache stickers match deploy106", () => {
  ...
  const masterHtml = readFileSync(path.join(root, "master.html"), "utf8");
  assert.match(masterHtml, /20260905deploy112/);
  assert.doesNotMatch(masterHtml, /20260905deploy111/);
